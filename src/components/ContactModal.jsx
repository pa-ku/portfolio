...
export default function ContactModal({ modalRef }) {
  ...
  return (
    <>
      ...
      <dialog
        ref={modalRef}
        className='right-0 left-0 m-auto z-50 rounded-lg w-full md:w-[35em]'
      >
        <div className='flex gap-2 flex-col items-start py-3 px-4   '>
          <form method='dialog' className='flex w-full gap-2 flex-col'>
            <div className='p-1 flex w-full justify-between items-center'>
              ...
              <button
                className='relative group duration-100 w-7 h-7 flex items-center justify-end text-primary-500  hover:text-primary-400'
            ...
            <input
              className='rounded-md bg-gray-100 text-lg w-full py-2 px-3'
              type='email'
            ...
            />
            <textarea
              className='w-full bg-gray-100  rounded-md h-60 text-lg py-2 px-3'
              type='text'
              value={message}
            ...
            <button
              onClick={sendForm}
              type='submit'
              className='bg-primary-500 hover:bg-primary-400 duration-100 text-white w-full rounded-md py-2'
            >
              Enviar
            </button>
          </form>
