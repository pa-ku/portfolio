    ...
    <>
      <Wrapper>
        <ConocimientoContainer>
          ...
          <IconWrapper>
            <Icon text={"Photoshop"} src={photoshopIcon} alt={"icono photoshop"}/>
        ...
        <ConocimientoContainer>
          ...
          <IconWrapper>
            ...
            <Icon text={"Styled"} src={styledicon} alt={"Icono Styled components"}/>
          </IconWrapper>
        </ConocimientoContainer>
        ...
        <ConocimientoContainer>
          ...
          <Subtitle fontSize={"14px"}>Codo a codo Full Stack PHP Julio 2022 Curso web de 6 meses orientado a Php, con conocimientos de Sql, Javascript, Css y html</Subtitle>
        </ConocimientoContainer>
      </Wrapper>
    </>
  );
