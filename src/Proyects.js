export const Proyects = [
  {
    ...
    description: [
      'Para facilitar la legibilidad y navegación se removieron botones repetidos y se utilizo un menú desplegable para agrupar elementos de la misma categoría',
      'Se agregaron colores en los hipervínculos con mayor contraste | Alt labels | keyboard navigation ',
      'Se mejoro el LCP en un 300%, de 3.2 segundos de carga a 0.8',
    ],
  },
  {
    name: 'Eride',
